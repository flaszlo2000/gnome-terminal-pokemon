#!/bin/sh
POKEMON_NAME_WITH_LONGEST_LINE=$(python3 /usr/local/opt/pokemon_show/pokemon-colorscripts-wrapper.py)
...
LINE_COUNT=$(pokemon-colorscripts -n $POKEMON_NAME | head -c -1 | wc -l)
